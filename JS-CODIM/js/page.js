...
document.getElementById("number").innerHTML =
  "Генерация случайного чисела от 0 до 10 = " + number;

const number3 = number ** 3; // возвели в куб
let nb3 = document.createElement('span');
nb3.innerHTML += ' ' + number3;
document.querySelector('.number3').appendChild(nb3);
